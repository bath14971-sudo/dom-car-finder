    ...
    <Link to={`/car/${car.id}`}>
      <Card className="group overflow-hidden cursor-pointer">
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <Badge variant={getStatusVariant(car.status)} className="absolute top-4 left-4">
        ...
        <CardContent className="p-5">
          <div className="space-y-3">
            <div>
              <p className="text-xs text-muted-foreground font-mono">{car.code}</p>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5 text-muted-foreground">
                ...
                <span className="text-sm">{car.viewers} people</span>
              </div>
            </div>
          </div>
        </CardContent>
